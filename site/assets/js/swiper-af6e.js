(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 980401, 985234, 812379, 809598, 941983, 872225, e => {
    "use strict";
    let t, i, s;
    var r = e.i(271645);
        ...
        for (let s = 1; s < e.length; s += 1) {
            ...
            if (null != r && ("undefined" != typeof window && void 0 !== window.HTMLElement ? !(r instanceof HTMLElement) : !r || 1 !== r.nodeType && 11 !== r.nodeType)) {
                ...
                for (let i = 0, s = e.length; i < s; i += 1) {
                    ...
                    void 0 !== a && a.enumerable && (h(t[s]) && h(r[s]) ? r[s].__swiper__ ? t[s] = r[s] : f(t[s], r[s]) : !h(t[s]) && h(r[s]) ? (t[s] = {}, r[s].__swiper__ ? t[s] = r[s] : f(t[s], r[s])) : t[s] = r[s])
                }
            }
        }
        return t
    ...
    function g({
        ...
        let o = t > a ? "next" : "prev",
            ...
            c = () => {
                ...
                let o = a + (.5 - Math.cos(Math.max(Math.min((s - l) / n, 1), 0) * Math.PI) / 2) * (t - a);
                if (d(o, t) && (o = t), e.wrapperEl.scrollTo({
                        [i]: o
                    }), d(o, t)) {
    ...
    function w(e, t = "") {
        let i = p(),
            s = [...e.children];
        return (i.HTMLSlotElement && e instanceof HTMLSlotElement && s.push(...e.assignedElements()), t) ? s.filter(e => e.matches(t)) : s
    }
    ...
    function P() {
        let e, i;
        return t || (e = p(), t = {
            smoothScroll: (i = o()).documentElement && i.documentElement.style && "scrollBehavior" in i.documentElement.style,
    ...
    function L(e = {}) {
        return i || (i = function({
            ...
            let t = P(),
                ...
                d = r.match(/(iPad)(?!\1).*OS\s([\d_]+)/),
                c = r.match(/(iPod)(.*OS\s([\d_]+))?/),
                u = !d && r.match(/(iPhone\sOS|iOS)\s([\d_]+)/),
                h = "MacIntel" === s;
            return !d && h && t.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${l}x${n}`) >= 0 && ((d = r.match(/(Version)\/([\d.]+)/)) || (d = [0, 1, "13_0_0"]), h = !1), o && "Win32" !== s && (a.os = "android", a.android = !0), (d || u || c) && (a.os = "ios", a.ios = !0), a
        }(e)), i
    }
        ...
        z = e => {
            ...
            if (e.params.rewind || e.params.loop)
                for (let s = r - t; s <= a + t; s += 1) {
                    ...
                    for (let s = Math.max(r - t, 0); s <= Math.min(a + t, i - 1); s += 1) s !== r && (s > a || s < r) && _(e, s)
        };
    ...
    function G(e) {
        ...
        if ("pointerdown" === l.type) {
            if (null !== n.pointerId && n.pointerId !== l.pointerId) return;
            n.pointerId = l.pointerId
        } else "touchstart" === l.type && 1 === l.targetTouches.length && (n.touchId = l.targetTouches[0].identifier);
        if ("touchstart" === l.type) return void $(this, l, l.targetTouches[0].pageX);
        let {
            params: d,
            touches: c,
            enabled: h
        } = this;
        if (!h || !d.simulateTouch && "mouse" === l.pointerType || this.animating && d.preventInteractionOnTransition) return;
        !this.animating && d.cssMode && d.loop && this.loopFix();
        let f = l.target;
        if ("wrapper" === d.touchEventsTarget && (t = f, i = this.wrapperEl, s = p(), !(r = i.contains(t)) && s.HTMLSlotElement && i instanceof HTMLSlotElement && ((r = [...i.assignedElements()].includes(t)) || (r = function(e, t) {
                let i = [t];
                for (; i.length > 0;) {
                    let t = i.shift();
                    if (e === t) return !0;
            ...
            }(t, i))), !r) || "which" in l && 3 === l.which || "button" in l && l.button > 0 || n.isTouched && n.isMoved) return;
        let m = !!d.noSwipingClass && "" !== d.noSwipingClass,
            g = l.composedPath ? l.composedPath() : l.path;
        m && l.target && l.target.shadowRoot && g && (f = g[0]);
        let v = d.noSwipingSelector ? d.noSwipingSelector : `.${d.noSwipingClass}`,
            w = !!(l.target && l.target.shadowRoot);
        if (d.noSwiping && (w ? function(e, t = this) {
                return function t(i) {
                    if (!i || i === o() || i === p()) return null;
        ...
        if (d.swipeHandler && !f.closest(d.swipeHandler)) return;
        c.currentX = l.pageX, c.currentY = l.pageY;
        let b = c.currentX,
            y = c.currentY;
        if (!$(this, l, b)) return;
        Object.assign(n, {
            ...
            isScrolling: void 0,
            startMoving: void 0
        }), c.startX = b, c.startY = y, n.touchStartTime = u(), this.allowClick = !0, this.updateSize(), this.swipeDirection = void 0, d.threshold > 0 && (n.allowThresholdMove = !1);
        let S = !0;
        f.matches(n.focusableElements) && (S = !1, "SELECT" === f.nodeName && (n.isTouched = !1)), a.activeElement && a.activeElement.matches(n.focusableElements) && a.activeElement !== f && ("mouse" === l.pointerType || "mouse" !== l.pointerType && !f.matches(n.focusableElements)) && a.activeElement.blur();
        let E = S && this.allowTouchMove && d.touchStartPreventDefault;
        (d.touchStartForcePreventDefault || E) && !f.isContentEditable && l.preventDefault(), d.freeMode && d.freeMode.enabled && this.freeMode && this.animating && !d.cssMode && this.freeMode.onTouchStart(), this.emit("touchStart", l)
    }
    ...
    function N(e) {
        ...
        if (a.touchReleaseOnEdges && !a.loop) {
            ...
            } else if (n && (c > l.startX && -this.translate <= this.maxTranslate() || c < l.startX && -this.translate >= this.minTranslate())) return;
            else if (!n && (c < l.startX && this.translate <= this.maxTranslate() || c > l.startX && this.translate >= this.minTranslate())) return
        }
        ...
        a.oneWayMovement && (g = Math.abs(g) * (n ? 1 : -1), v = Math.abs(v) * (n ? 1 : -1)), l.diff = g, g *= a.touchRatio, n && (g = -g, v = -v);
    ...
    function B(e) {
        ...
        if (r.isTouched = !1, r.isMoved = !1, r.startMoving = !1, i = l.followFinger ? o ? s.translate : -s.translate : -r.currentTranslate, l.cssMode) return;
        ...
        for (let e = 0; e < d.length; e += e < l.slidesPerGroupSkip ? 1 : l.slidesPerGroup) {
            ...
            void 0 !== d[e + t] ? (m || i >= d[e] && i < d[e + t]) && (g = e, v = d[e + t] - d[e]) : (m || i >= d[e]) && (g = e, v = d[d.length - 1] - d[d.length - 2])
        }
        let w = null,
            b = null;
        l.rewind && (s.isBeginning ? b = l.virtual && l.virtual.enabled && s.virtual ? s.virtual.slides.length - 1 : s.slides.length - 1 : s.isEnd && (w = 0));
        let y = (i - d[g]) / v,
            S = g < l.slidesPerGroupSkip - 1 ? 1 : l.slidesPerGroup;
        if (f > l.longSwipesMs) {
            if (!l.longSwipes) return void s.slideTo(s.activeIndex);
            "next" === s.swipeDirection && (y >= l.longSwipesRatio ? s.slideTo(l.rewind && s.isEnd ? w : g + S) : s.slideTo(g)), "prev" === s.swipeDirection && (y > 1 - l.longSwipesRatio ? s.slideTo(g + S) : null !== b && y < 0 && Math.abs(y) > l.longSwipesRatio ? s.slideTo(b) : s.slideTo(g))
        } else {
            if (!l.shortSwipes) return void s.slideTo(s.activeIndex);
            s.navigation && (a.target === s.navigation.nextEl || a.target === s.navigation.prevEl) ? a.target === s.navigation.nextEl ? s.slideTo(g + S) : s.slideTo(g) : ("next" === s.swipeDirection && s.slideTo(null !== w ? w : g + S), "prev" === s.swipeDirection && s.slideTo(null !== b ? b : g))
        }
    }
    ...
    function R(e) {
        I(this, e.target), !this.params.cssMode && ("auto" === this.params.slidesPerView || this.params.autoHeight) && this.update()
    }
    ...
    let q = (e, t) => {
            ...
            r && "string" != typeof r && (i[d]("touchstart", e.onDocumentTouchStart, {
                ...
                passive: !0
            }), (s.preventClicks || s.preventClicksPropagation) && r[d]("click", e.onClick, !0), s.cssMode && a[d]("scroll", e.onScroll), s.updateOnWindowResize ? e[t](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", F, !0) : e[t]("observerUpdate", F, !0), r[d]("load", e.onLoad, {
                capture: !0
            }))
        },
    ...
    let Y = {
            ...
            update: {
                ...
                updateSlides: function() {
                    ...
                    let s = t.params,
                        ...
                        p = w(a, `.${t.params.slideClass}, swiper-slide`),
                        c = o ? t.virtual.slides.length : p.length,
                        u = [],
                        h = [],
                        f = [],
                    ...
                    let b = t.snapGrid.length,
                        ...
                        P = 0;
                    if (void 0 === E) return;
                    "string" == typeof T && T.indexOf("%") >= 0 ? T = parseFloat(T.replace("%", "")) / 100 * E : "string" == typeof T && (T = parseFloat(T)), t.virtualSize = -T - g - v, p.forEach(e => {
                    ...
                    L ? t.grid.initSlides(p) : t.grid && t.grid.unsetSlides();
                    ...
                    for (let r = 0; r < c; r += 1) {
                        e = 0;
                        let a = p[r];
                        if (!a || (L && t.grid.updateSlide(r, a, p), "none" !== S(a, "display"))) {
                            if (o && "auto" === s.slidesPerView) s.virtual.slidesPerViewAutoSlideSize && (e = s.virtual.slidesPerViewAutoSlideSize), e && a && (s.roundLengths && (e = Math.floor(e)), a.style[t.getDirectionLabel("width")] = `${e}px`);
                            else if ("auto" === s.slidesPerView) {
                                k && (a.style[t.getDirectionLabel("width")] = "");
                                let r = getComputedStyle(a),
                                    l = a.style.transform,
                                    n = a.style.webkitTransform;
                                if (l && (a.style.transform = "none"), n && (a.style.webkitTransform = "none"), s.roundLengths) e = t.isHorizontal() ? x(a, "width", !0) : x(a, "height", !0);
                                else {
                                    let t = i(r, "width"),
                                        s = i(r, "padding-left"),
                                        l = i(r, "padding-right"),
                            ...
                            } else e = (E - (s.slidesPerView - 1) * T) / s.slidesPerView, s.roundLengths && (e = Math.floor(e)), a && (a.style[t.getDirectionLabel("width")] = `${e}px`);
                            a && (a.swiperSlideSize = e), f.push(e), s.centeredSlides ? (C = C + e / 2 + M / 2 + T, 0 === M && 0 !== r && (C = C - E / 2 - T), 0 === r && (C = C - E / 2 - T), .001 > Math.abs(C) && (C = 0), s.roundLengths && (C = Math.floor(C)), P % s.slidesPerGroup == 0 && u.push(C), h.push(C)) : (s.roundLengths && (C = Math.floor(C)), (P - Math.min(t.params.slidesPerGroupSkip, P)) % t.params.slidesPerGroup == 0 && u.push(C), h.push(C), C = C + e + T), t.virtualSize += e + T, M = e, P += 1
                        }
                    }
                    if (t.virtualSize = Math.max(t.virtualSize, E) + v, l && n && ("slide" === s.effect || "coverflow" === s.effect) && (r.style.width = `${t.virtualSize+T}px`), s.setWrapperSize && (r.style[t.getDirectionLabel("width")] = `${t.virtualSize+T}px`), L && t.grid.updateWrapperSize(e, u), !s.centeredSlides) {
                        let e = [];
                        for (let i = 0; i < u.length; i += 1) {
                            let r = u[i];
                            s.roundLengths && (r = Math.floor(r)), u[i] <= t.virtualSize - E && e.push(r)
                        }
                        u = e, Math.floor(t.virtualSize - E) - Math.floor(u[u.length - 1]) > 1 && u.push(t.virtualSize - E)
                    }
                    if (o && s.loop) {
                        let e = f[0] + T;
                        ...
                        for (let i = 0; i < t.virtual.slidesBefore + t.virtual.slidesAfter; i += 1) 1 === s.slidesPerGroup && u.push(u[u.length - 1] + e), h.push(h[h.length - 1] + e), t.virtualSize += e
                    }
                    ...
                    if (Object.assign(t, {
                        ...
                        m(r, "--swiper-centered-offset-before", `${-u[0]}px`), m(r, "--swiper-centered-offset-after", `${t.size/2-f[f.length-1]/2}px`);
                        let e = -t.snapGrid[0],
                            i = -t.slidesGrid[0];
                        t.snapGrid = t.snapGrid.map(t => t + e), t.slidesGrid = t.slidesGrid.map(e => e + i)
                    }
                    if (c !== d && t.emit("slidesLengthChange"), u.length !== b && (t.params.watchOverflow && t.checkOverflow(), t.emit("snapGridLengthChange")), h.length !== y && t.emit("slidesGridLengthChange"), s.watchSlidesProgress && t.updateSlidesOffset(), t.emit("slidesUpdated"), !o && !s.cssMode && ("slide" === s.effect || "fade" === s.effect)) {
                ...
                updateSlidesProgress: function(e = this && this.translate || 0) {
                    ...
                    for (let e = 0; e < i.length; e += 1) {
                        ...
                        let d = (a + (t.centeredSlides ? this.minTranslate() : 0) - o) / (n.swiperSlideSize + l),
                            ...
                            f = c >= 0 && c < this.size - 1 || u > 1 && u <= this.size || c <= 0 && u >= this.size;
                        f && (this.visibleSlides.push(n), this.visibleSlidesIndexes.push(e)), O(n, f, t.slideVisibleClass), O(n, h, t.slideFullyVisibleClass), n.progress = s ? -d : d, n.originalProgress = s ? -p : p
                    }
                },
                ...
                updateSlidesClasses: function() {
                    let e, t, i, {
                        ...
                        d = e => w(a, `.${r.slideClass}${e}, swiper-slide${e}`)[0];
                    if (n)
                        if (r.loop) {
                    ...
                    else o ? (e = s.find(e => e.column === l), i = s.find(e => e.column === l + 1), t = s.find(e => e.column === l - 1)) : e = s[l];
                    e && !o && (i = function(e, t) {
                        let i = [];
                        ...
                        A(s, s === e, r.slideActiveClass), A(s, s === i, r.slideNextClass), A(s, s === t, r.slidePrevClass)
                ...
                updateActiveIndex: function(e) {
                    ...
                    Object.assign(s, {
                        ...
                        previousIndex: n,
                        activeIndex: p
                    }), s.initialized && z(s), s.emit("activeIndexChange"), s.emit("snapIndexChange"), (s.initialized || s.params.runCallbacksOnInit) && (o !== i && s.emit("realIndexChange"), s.emit("slideChange"))
                },
            ...
            translate: {
                getTranslate: function(e = this.isHorizontal() ? "x" : "y") {
                    ...
                    let a = function(e, t = "x") {
                        let i, s, r, a, l, n = p(),
                            o = ((l = p()).getComputedStyle && (a = l.getComputedStyle(e, null)), !a && e.currentStyle && (a = e.currentStyle), a || (a = e.style), a);
                ...
                translateTo: function(e = 0, t = this.params.speed, i = !0, s = !0, r) {
                    ...
                    let d = l.minTranslate(),
                        p = l.maxTranslate();
                    if (a = s && e > d ? d : s && e < p ? p : e, l.updateProgress(a), n.cssMode) {
            ...
            transition: {
                ...
                transitionStart: function(e = !0, t) {
                    ...
                    i.cssMode || (i.autoHeight && this.updateAutoHeight(), D({
                        swiper: this,
                        runCallbacks: e,
                        direction: t,
                        step: "Start"
                ...
                transitionEnd: function(e = !0, t) {
                    ...
                    this.animating = !1, i.cssMode || (this.setTransition(0), D({
                        swiper: this,
                        runCallbacks: e,
                        direction: t,
                        step: "End"
            ...
            slide: {
                slideTo: function(e = 0, t, i = !0, s, r) {
                    ...
                    if (!m && !s && !r || l.destroyed || l.animating && o.preventInteractionOnTransition) return !1;
                    ...
                    if (l.initialized && n !== u && (!l.allowSlideNext && (h ? b > l.translate && b > l.minTranslate() : b < l.translate && b < l.minTranslate()) || !l.allowSlidePrev && b > l.translate && b > l.maxTranslate() && (u || 0) !== n)) return !1;
                    n !== (c || 0) && i && l.emit("beforeSlideChangeStart"), l.updateProgress(b), a = n > u ? "next" : n < u ? "prev" : "reset";
                    let y = l.virtual && l.params.virtual.enabled;
                    if (!(y && r) && (h && -b === l.translate || !h && b === l.translate)) return l.updateActiveIndex(n), o.autoHeight && l.updateAutoHeight(), l.updateSlidesClasses(), "slide" !== o.effect && l.setTranslate(b), "reset" !== a && (l.transitionStart(i, a), l.transitionEnd(i, a)), !1;
                    if (o.cssMode) {
                        let e = l.isHorizontal(),
                            i = h ? b : -b;
                        if (0 === t) y && (l.wrapperEl.style.scrollSnapType = "none", l._immediateVirtual = !0), y && !l._cssModeVirtualInitialSet && l.params.initialSlide > 0 ? (l._cssModeVirtualInitialSet = !0, requestAnimationFrame(() => {
                            f[e ? "scrollLeft" : "scrollTop"] = i
                        })) : f[e ? "scrollLeft" : "scrollTop"] = i, y && requestAnimationFrame(() => {
                    ...
                    if (r.params.loop)
                        if (r.virtual && r.params.virtual.enabled) l += r.virtual.slidesBefore;
                            ...
                            let t = a ? Math.ceil(r.slides.length / r.params.grid.rows) : r.slides.length,
                                ...
                                d = i || !!n || !!o,
                                p = r.params.slidesPerView;
                            "auto" === p ? p = r.slidesPerViewDynamic() : (p = Math.ceil(parseFloat(r.params.slidesPerView, 10)), d && p % 2 == 0 && (p += 1));
                            let c = t - e < p;
                            if (d && (c = c || e < Math.ceil(p / 2)), s && d && "auto" !== r.params.slidesPerView && !a && (c = !1), c) {
                ...
                slideToClickedSlide: function() {
                    ...
                    if (i.loop) {
                        ...
                        e = parseInt(t.clickedSlide.getAttribute("data-swiper-slide-index"), 10), i.centeredSlides ? t.slideToLoop(e) : a > (n ? (t.slides.length - r) / 2 - (t.params.grid.rows - 1) : t.slides.length - r) ? (t.loopFix(), a = t.getSlideIndex(w(s, `${l}[data-swiper-slide-index="${e}"]`)[0]), c(() => {
                            t.slideTo(a)
                        })) : t.slideTo(a)
                    } else t.slideTo(a)
                }
            ...
            loop: {
                ...
                loopFix: function({
                    ...
                    if (o.allowSlidePrev = !0, o.allowSlideNext = !0, o.virtual && h.virtual.enabled) {
                        t && (w || 0 !== o.snapIndex ? w && o.snapIndex < h.slidesPerView ? o.slideTo(o.virtual.slides.length + o.snapIndex, 0, !1, !0) : o.snapIndex === o.snapGrid.length - 1 && o.slideTo(o.virtual.slidesBefore, 0, !1, !0) : o.slideTo(o.virtual.slides.length, 0, !1, !0)), o.allowSlidePrev = p, o.allowSlideNext = c, o.emit("loopFix");
                        return
                    }
                    let y = h.slidesPerView;
                    "auto" === y ? y = o.slidesPerViewDynamic() : (y = Math.ceil(parseFloat(h.slidesPerView, 10)), w && y % 2 == 0 && (y += 1));
                    let S = h.slidesPerGroupAuto ? y : h.slidesPerGroup,
                        E = w ? Math.max(S, Math.ceil(y / 2)) : S;
                    E % S != 0 && (E += S - E % S), o.loopedSlides = E += h.loopAdditionalSlides;
                    let T = o.grid && h.grid && h.grid.rows > 1;
                    d.length < y + E || "cards" === o.params.effect && d.length < y + 2 * E ? b("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled or not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : T && "row" === h.grid.fill && b("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
                    let x = [],
                        C = [],
                        M = T ? Math.ceil(d.length / h.grid.rows) : d.length,
                        P = a && M - v < y && !w,
                        L = P ? v : o.activeIndex;
                    void 0 === r ? r = o.getSlideIndex(d.find(e => e.classList.contains(h.slideActiveClass))) : L = r;
                    let k = "next" === i || !i,
                        O = "prev" === i || !i,
                        A = 0,
                        I = 0,
                        _ = (T ? d[r].column : r) + (w && void 0 === s ? -y / 2 + .5 : 0);
                    if (_ < E) {
                        A = Math.max(E - _, S);
                        for (let e = 0; e < E - _; e += 1) {
                            ...
                            if (T) {
                                let e = M - t - 1;
                                for (let t = d.length - 1; t >= 0; t -= 1) d[t].column === e && x.push(t)
                            } else x.push(M - t - 1)
                        }
                    } else if (_ + y > M - E) {
                        I = Math.max(_ - (M - 2 * E), S), P && (I = Math.max(I, y - M + v + 1));
                        for (let e = 0; e < I; e += 1) {
                            let t = e - Math.floor(e / M) * M;
                            T ? d.forEach((e, i) => {
                                e.column === t && C.push(i)
                    ...
                    if (o.__preventObserver__ = !0, requestAnimationFrame(() => {
                        ...
                        }), "cards" === o.params.effect && d.length < y + 2 * E && (C.includes(r) && C.splice(C.indexOf(r), 1), x.includes(r) && x.splice(x.indexOf(r), 1)), O && x.forEach(e => {
                            d[e].swiperLoopMoveDOM = !0, u.prepend(d[e]), d[e].swiperLoopMoveDOM = !1
                        }), k && C.forEach(e => {
                            d[e].swiperLoopMoveDOM = !0, u.append(d[e]), d[e].swiperLoopMoveDOM = !1
                        }), o.recalcSlides(), "auto" === h.slidesPerView ? o.updateSlides() : T && (x.length > 0 && O || C.length > 0 && k) && o.slides.forEach((e, t) => {
                            o.grid.updateSlide(t, e, o.slides)
                        }), h.watchSlidesProgress && o.updateSlidesOffset(), t) {
                        if (x.length > 0 && O) {
                            if (void 0 === e) {
                                let e = o.slidesGrid[L],
                                    t = o.slidesGrid[L + A] - e;
                                n ? o.setTranslate(o.translate - t) : (o.slideTo(L + Math.ceil(A), 0, !1, !0), s && (o.touchEventsData.startTranslate = o.touchEventsData.startTranslate - t, o.touchEventsData.currentTranslate = o.touchEventsData.currentTranslate - t))
                            } else if (s) {
                                let e = T ? x.length / h.grid.rows : x.length;
                                o.slideTo(o.activeIndex + e, 0, !1, !0), o.touchEventsData.currentTranslate = o.translate
                            }
                        } else if (C.length > 0 && k)
                            if (void 0 === e) {
                                let e = o.slidesGrid[L],
                                    t = o.slidesGrid[L - I] - e;
                                n ? o.setTranslate(o.translate - t) : (o.slideTo(L - I, 0, !1, !0), s && (o.touchEventsData.startTranslate = o.touchEventsData.startTranslate - t, o.touchEventsData.currentTranslate = o.touchEventsData.currentTranslate - t))
                            } else {
                                let e = T ? C.length / h.grid.rows : C.length;
                    ...
                    if (o.allowSlidePrev = p, o.allowSlideNext = c, o.controller && o.controller.control && !l) {
                        ...
                        Array.isArray(o.controller.control) ? o.controller.control.forEach(e => {
                            ...
                            ...a,
                            slideTo: o.controller.control.params.slidesPerView === h.slidesPerView && t
                        })
                    }
                    o.emit("loopFix")
                },
            ...
            events: {
                attachEvents: function() {
                    ...
                    this.onTouchStart = G.bind(this), this.onTouchMove = N.bind(this), this.onTouchEnd = B.bind(this), this.onDocumentTouchStart = H.bind(this), e.cssMode && (this.onScroll = j.bind(this)), this.onClick = V.bind(this), this.onLoad = R.bind(this), q(this, "on")
                },
            ...
            breakpoints: {
                setBreakpoint: function() {
                    ...
                    let l = o(),
                        n = "window" !== s.breakpointsBase && s.breakpointsBase ? "container" : s.breakpointsBase,
                        d = ["window", "container"].includes(s.breakpointsBase) || !s.breakpointsBase ? e.el : l.querySelector(s.breakpointsBase),
                        p = e.getBreakpoint(a, n, d);
                    if (!p || e.currentBreakpoint === p) return;
                    let c = (p in a ? a[p] : void 0) || e.originalParams,
                        u = W(e, s),
                        h = W(e, c),
                        m = e.params.grabCursor,
                        g = c.grabCursor,
                        v = s.enabled;
                    u && !h ? (r.classList.remove(`${s.containerModifierClass}grid`, `${s.containerModifierClass}grid-column`), e.emitContainerClasses()) : !u && h && (r.classList.add(`${s.containerModifierClass}grid`), (c.grid.fill && "column" === c.grid.fill || !c.grid.fill && "column" === s.grid.fill) && r.classList.add(`${s.containerModifierClass}grid-column`), e.emitContainerClasses()), m && !g ? e.unsetGrabCursor() : !m && g && e.setGrabCursor(), ["navigation", "pagination", "scrollbar"].forEach(t => {
                        if (void 0 === c[t]) return;
                        let i = s[t] && s[t].enabled,
                            r = c[t] && c[t].enabled;
                        i && !r && e[t].disable(), !i && r && e[t].enable()
                    });
                    let w = c.direction && c.direction !== s.direction,
                        b = s.loop && (c.slidesPerView !== s.slidesPerView || w),
                        y = s.loop;
                    w && i && e.changeDirection(), f(e.params, c);
                    ...
                    }), v && !S ? e.disable() : !v && S && e.enable(), e.currentBreakpoint = p, e.emit("_beforeBreakpoint", c), i && (b ? (e.loopDestroy(), e.loopCreate(t), e.updateSlides()) : !y && E ? (e.loopCreate(t), e.updateSlides()) : y && !E && e.loopDestroy()), e.emit("breakpoint", c)
                },
            ...
            classes: {
                addClasses: function() {
                    ...
                    let i, {
                        ...
                        }], t = r.containerModifierClass, i = [], e.forEach(e => {
                            "object" == typeof e ? Object.keys(e).forEach(s => {
                                e[s] && i.push(t + s)
                            }) : "string" == typeof e && i.push(t + e)
                        }), i);
                    s.push(...o), l.classList.add(...s), this.emitContainerClasses()
                },
    ...
    class K {
        constructor(...e) {
            let t, i;
            1 === e.length && e[0].constructor && "Object" === Object.prototype.toString.call(e[0]).slice(8, -1) ? i = e[0] : [t, i] = e, i || (i = {}), i = f({}, i), t && !i.el && (i.el = t);
            const s = o();
            ...
            const r = this;
            r.__swiper__ = !0, r.support = P(), r.device = L({
                userAgent: i.userAgent
            }), r.browser = k(), r.eventsListeners = {}, r.eventsAnyListeners = [], r.modules = [...r.__modules__], i.modules && Array.isArray(i.modules) && r.modules.push(...i.modules);
            const a = {};
            r.modules.forEach(e => {
                var t;
                e({
                    ...
                    extendParams: (t = i, function(e = {}) {
                        let i = Object.keys(e)[0],
                            s = e[i];
                        "object" != typeof s || null === s || (!0 === t[i] && (t[i] = {
                            enabled: !0
                        }), "navigation" === i && t[i] && t[i].enabled && !t[i].prevEl && !t[i].nextEl && (t[i].auto = !0), ["pagination", "scrollbar"].indexOf(i) >= 0 && t[i] && t[i].enabled && !t[i].el && (t[i].auto = !0), i in t && "enabled" in s && ("object" != typeof t[i] || "enabled" in t[i] || (t[i].enabled = !0), t[i] || (t[i] = {
                            enabled: !1
                        }))), f(a, e)
                    }),
                    on: r.on.bind(r),
            ...
            const l = f({}, X, a);
            return r.params = f({}, l, U, i), r.originalParams = f({}, r.params), r.passedParams = f({}, i), r.params && r.params.on && Object.keys(r.params.on).forEach(e => {
        ...
        getSlideIndex(e) {
            let {
                slidesEl: t,
                params: i
            } = this, s = E(w(t, `.${i.slideClass}, swiper-slide`)[0]);
            return E(e) - s
        }
        ...
        mount(e) {
            ...
            let s = () => `.${(t.params.wrapperClass||"").trim().split(" ").join(".")}`,
                r = i && i.shadowRoot && i.shadowRoot.querySelector ? i.shadowRoot.querySelector(s()) : w(i, s())[0];
            return !r && t.params.createElements && (r = y("div", t.params.wrapperClass), i.append(r), w(i, `.${t.params.slideClass}`).forEach(e => {
                r.append(e)
            })), Object.assign(t, {
                el: i,
                wrapperEl: r,
        ...
        destroy(e = !0, t = !0) {
            ...
            (i.emit("beforeDestroy"), i.initialized = !1, i.detachEvents(), s.loop && i.loopDestroy(), t && (i.removeClasses(), r && "string" != typeof r && r.removeAttribute("style"), a && a.removeAttribute("style"), l && l.length && l.forEach(e => {
                ...
                i.off(e)
            }), !1 !== e) && (i.el && "string" != typeof i.el && (i.el.swiper = null), Object.keys(i).forEach(e => {
                try {
                    i[e] = null
                } catch (e) {}
                try {
    ...
    Object.keys(Y).forEach(e => {
        ...
        t("init", () => {
            ...
            })).observe(e.el) : (s.addEventListener("resize", l), s.addEventListener("orientationchange", n))
        }), t("destroy", () => {
            a && s.cancelAnimationFrame(a), r && r.unobserve && e.el && (r.unobserve(e.el), r = null), s.removeEventListener("resize", l), s.removeEventListener("orientationchange", n)
        })
    }, function({
        swiper: e,
        extendParams: t,
    ...
    function Q(e, t) {
        let i = ["__proto__", "constructor", "prototype"];
        Object.keys(t).filter(e => 0 > i.indexOf(e)).forEach(i => {
            void 0 === e[i] ? e[i] = t[i] : J(t[i]) && J(e[i]) && Object.keys(t[i]).length > 0 ? t[i].__swiper__ ? e[i] = t[i] : Q(e[i], t[i]) : e[i] = t[i]
        })
    }
    ...
    let en = (0, r.createContext)(null),
        ...
        ed = (0, r.forwardRef)(({
            ...
            let o, d, p = !1,
                ...
                C = (0, r.useRef)(null),
                {
                    ...
                    let i = {
                        ...
                        s = {},
                        r = {};
                    Q(i, X), i._emitClasses = !0, i.init = !1;
                    let a = {},
                        l = Z.map(e => e.replace(/_/, ""));
                    return Object.keys(Object.assign({}, e)).forEach(n => {
                        void 0 !== e[n] && (l.indexOf(n) >= 0 ? J(e[n]) ? (i[n] = {}, r[n] = {}, Q(i[n], e[n]), Q(r[n], e[n])) : (i[n] = e[n], r[n] = e[n]) : 0 === n.search(/on[A-Z]/) && "function" == typeof e[n] ? t ? s[`${n[2].toLowerCase()}${n.substr(3)}`] = e[n] : i.on[`${n[2].toLowerCase()}${n.substr(3)}`] = e[n] : a[n] = e[n])
                ...
                }(l),
                {
                    ...
                    "wrapper-start": [],
                    "wrapper-end": []
                }, r.default.Children.toArray(s).forEach(e => {
                    if (ea(e)) o.push(e);
                    else if (e.props && e.props.slot && d[e.props.slot]) d[e.props.slot].push(e);
                    else if (e.props && e.props.children) {
                        let t = function e(t) {
                            let i = [];
                            return r.default.Children.toArray(t).forEach(t => {
                                ea(t) ? i.push(t) : t.props && t.props.children && e(t.props.children).forEach(e => i.push(e))
                            }), i
                        }(e.props.children);
                        t.length > 0 ? t.forEach(e => o.push(e)) : d["container-end"].push(e)
                    } else d["container-end"].push(e)
                }), {
                    slides: o,
                    slots: d
                }),
            ...
            let z = () => {
                Object.assign(P.on, O), p = !0;
                let e = {
                    ...P
                };
                if (delete e.wrapperClass, b.current = new K(e), b.current.virtual && b.current.params.virtual.enabled) {
                    ...
                    Q(b.current.params.virtual, e), Q(b.current.originalParams.virtual, e)
                }
            };
            return w.current || z(), b.current && b.current.on("_beforeBreakpoint", _), (0, r.useEffect)(() => () => {
                b.current && b.current.off("_beforeBreakpoint", _)
            }), (0, r.useEffect)(() => {
                !v.current && b.current && (b.current.emitSlidesClasses(), v.current = !0)
            }), el(() => {
                if (n && (n.current = w.current), w.current) return b.current.destroyed && z(), ! function({
                    el: e,
                    nextEl: t,
                    prevEl: i,
                    paginationEl: s,
                    ...
                    ee(l) && t && i && (a.params.navigation.nextEl = t, a.originalParams.navigation.nextEl = t, a.params.navigation.prevEl = i, a.originalParams.navigation.prevEl = i), et(l) && s && (a.params.pagination.el = s, a.originalParams.pagination.el = s), ei(l) && r && (a.params.scrollbar.el = r, a.originalParams.scrollbar.el = r), a.init(e)
                }({
                    el: w.current,
                    nextEl: E.current,
                    prevEl: T.current,
                    ...
                    swiper: b.current
                }, P), a && !b.current.destroyed && a(b.current), () => {
                ...
                let e = function(e, t, i, s, r) {
                    ...
                    return Z.filter(e => "_" === e[0]).map(e => e.replace(/_/, "")).forEach(i => {
                        if (i in e && i in t)
                            if (J(e[i]) && J(t[i])) {
                ...
                }(L, y.current, A, S.current, e => e.key);
                return y.current = L, S.current = A, e.length && b.current && !b.current.destroyed && function({
                    swiper: e,
                    slides: t,
                    passedParams: i,
                    changedParams: s,
                    ...
                    let o, d, p, c, u, h, f, m, g = s.filter(e => "children" !== e && "direction" !== e && "wrapperClass" !== e),
                        {
                            params: v,
                            pagination: w,
                            navigation: b,
            ...
            }, [h]), r.default.createElement(t, er({
                ref: w,
                className: es(`${c}${e?` ${e}`:""}`)
            }, k), r.default.createElement(eo.Provider, {
                value: b.current
            }, I["container-start"], r.default.createElement(i, {
                className: function(e = "") {
                    return e ? e.includes("swiper-wrapper") ? e : `swiper-wrapper ${e}` : "swiper-wrapper"
                }(P.wrapperClass)
            }, I["wrapper-start"], P.virtual ? function(e, t, i) {
                if (!i) return null;
                let s = e => {
                        let i = e;
                    ...
                    p = [];
                for (let e = o; e < d; e += 1) e >= l && e <= n && p.push(t[s(e)]);
                return p.map((t, i) => r.default.cloneElement(t, {
                    swiper: e,
                    style: a,
                    key: t.props.virtualIndex || t.key || `slide-${i}`
                }))
            }(b.current, A, h) : A.map((e, t) => r.default.cloneElement(e, {
                swiper: b.current,
                swiperSlideIndex: t
            })), I["wrapper-end"]), ee(P) && r.default.createElement(r.default.Fragment, null, r.default.createElement("div", {
                ref: T,
                className: "swiper-button-prev"
            }), r.default.createElement("div", {
                ref: E,
                className: "swiper-button-next"
            })), ei(P) && r.default.createElement("div", {
                ref: C,
                className: "swiper-scrollbar"
            }), et(P) && r.default.createElement("div", {
                ref: x,
                className: "swiper-pagination"
            }), I["container-end"]))
        });
    ed.displayName = "Swiper";
    let ep = (0, r.forwardRef)(({
        tag: e = "div",
        children: t,
        className: i = "",
        swiper: s,
        ...
        el(() => {
            if (void 0 !== o && (c.current.swiperSlideIndex = o), p && (p.current = c.current), c.current && s) {
                if (s.destroyed) {
            ...
            s && c.current && !s.destroyed && h(s.getSlideClasses(c.current))
        }, [s]);
        let v = {
        ...
        return r.default.createElement(e, er({
            ref: c,
            className: es(`${u}${i?` ${i}`:""}`),
        ...
        }, d), a && r.default.createElement(en.Provider, {
            value: v
        }, r.default.createElement("div", {
            className: "swiper-zoom-container",
            "data-swiper-zoom": "number" == typeof a ? a : void 0
        }, w(), l && !f && r.default.createElement("div", {
            className: "swiper-lazy-preloader"
        }))), !a && r.default.createElement(en.Provider, {
            value: v
        }, w(), l && !f && r.default.createElement("div", {
            className: "swiper-lazy-preloader"
        })))
    ...
    function ec(e, t, i, s) {
        return e.params.createElements && Object.keys(s).forEach(r => {
            if (!i[r] && !0 === i.auto) {
                let a = w(e.el, `.${s[r]}`)[0];
                a || ((a = y("div", s[r])).className = s[r], e.el.append(a)), i[r] = a, t[r] = a
            }
        }), i
    }
    ep.displayName = "SwiperSlide", e.s(["Swiper", () => ed, "SwiperSlide", () => ep], 980401);
    let eu = '<svg class="swiper-navigation-icon" width="11" height="20" viewBox="0 0 11 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0.38296 20.0762C0.111788 19.805 0.111788 19.3654 0.38296 19.0942L9.19758 10.2796L0.38296 1.46497C0.111788 1.19379 0.111788 0.754138 0.38296 0.482966C0.654131 0.211794 1.09379 0.211794 1.36496 0.482966L10.4341 9.55214C10.8359 9.9539 10.8359 10.6053 10.4341 11.007L1.36496 20.0762C1.09379 20.3474 0.654131 20.3474 0.38296 20.0762Z" fill="currentColor"/></svg>';
    ...
    function eh({
        ...
        function r(t) {
            let i;
            return t && "string" == typeof t && e.isElement && (i = e.el.querySelector(t) || e.hostEl.querySelector(t)) ? i : (t && ("string" == typeof t && (i = [...document.querySelectorAll(t)]), e.params.uniqueNavElements && "string" == typeof t && i && i.length > 1 && 1 === e.el.querySelectorAll(t).length ? i = e.el.querySelector(t) : i && 1 === i.length && (i = i[0])), t && !i) ? t : i
        }
        ...
        function d() {
            ...
            if (e.params.navigation = ec(e, e.originalParams.navigation, e.params.navigation, {
            ...
            let a = (i, s) => {
                if (i) {
                    if (t.addIcons && i.matches(".swiper-button-next,.swiper-button-prev") && !i.querySelector("svg")) {
                        ...
                        M(e, eu), i.appendChild(e.querySelector("svg")), e.remove()
                    }
                    i.addEventListener("click", "next" === s ? o : n)
        ...
        function p() {
            ...
            t = C(t), i = C(i);
            let s = (t, i) => {
                t.removeEventListener("click", "next" === i ? o : n), t.classList.remove(...e.params.navigation.disabledClass.split(" "))
            };
        ...
        t({
            ...
            !1 === e.params.navigation.enabled ? c() : (d(), l())
            ...
            (t = C(t), i = C(i), e.enabled) ? l(): [...t, ...i].filter(e => !!e).forEach(t => t.classList.add(e.params.navigation.lockClass))
        }), i("click", (t, i) => {
            let {
                nextEl: r,
                prevEl: a
            ...
            r = C(r), a = C(a);
            let l = i.target,
                n = a.includes(l) || r.includes(l);
            if (e.isElement && !n) {
                let e = i.path || i.composedPath && i.composedPath();
                e && (n = e.find(e => r.includes(e) || a.includes(e)))
            }
            if (e.params.navigation.hideOnClick && !n) {
                ...
                r.length ? t = r[0].classList.contains(e.params.navigation.hiddenClass) : a.length && (t = a[0].classList.contains(e.params.navigation.hiddenClass)), !0 === t ? s("navigationShow") : s("navigationHide"), [...r, ...a].filter(e => !!e).forEach(t => t.classList.toggle(e.params.navigation.hiddenClass))
            }
        });
        let c = () => {
    ...
    function em({
        ...
        function d(t) {
            let i = t.target.closest(ef(e.params.pagination.bulletClass));
            if (!i) return;
            t.preventDefault();
            let s = E(i) * e.params.slidesPerGroup;
            if (e.params.loop) {
                var r, a, l;
                if (e.realIndex === s) return;
                let t = (r = e.realIndex, a = s, (r %= l = e.slides.length, (a %= l) === r + 1) ? "next" : a === r - 1 ? "previous" : void 0);
        ...
        function p() {
            ...
            p = C(p);
            let c = e.virtual && e.params.virtual.enabled ? e.virtual.slides.length : e.slides.length,
                u = e.params.loop ? Math.ceil(c / e.params.slidesPerGroup) : e.snapGrid.length;
            if (e.params.loop ? (i = e.previousRealIndex || 0, t = e.params.slidesPerGroup > 1 ? Math.floor(e.realIndex / e.params.slidesPerGroup) : e.realIndex) : void 0 !== e.snapIndex ? (t = e.snapIndex, i = e.previousSnapIndex) : (i = e.previousIndex || 0, t = e.activeIndex || 0), "bullets" === d.type && e.pagination.bullets && e.pagination.bullets.length > 0) {
                let s, n, c, u = e.pagination.bullets;
                if (d.dynamicBullets && (r = x(u[0], e.isHorizontal() ? "width" : "height", !0), p.forEach(t => {
                        t.style[e.isHorizontal() ? "width" : "height"] = `${r*(d.dynamicMainBullets+4)}px`
                    }), d.dynamicMainBullets > 1 && void 0 !== i && ((l += t - (i || 0)) > d.dynamicMainBullets - 1 ? l = d.dynamicMainBullets - 1 : l < 0 && (l = 0)), c = ((n = (s = Math.max(t - l, 0)) + (Math.min(u.length, d.dynamicMainBullets) - 1)) + s) / 2), u.forEach(e => {
                        let t = [...["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map(e => `${d.bulletActiveClass}${e}`)].map(e => "string" == typeof e && e.includes(" ") ? e.split(" ") : e).flat();
                        e.classList.remove(...t)
                    }), p.length > 1) u.forEach(i => {
                    let r = E(i);
                    r === t ? i.classList.add(...d.bulletActiveClass.split(" ")) : e.isElement && i.setAttribute("part", "bullet"), d.dynamicBullets && (r >= s && r <= n && i.classList.add(...`${d.bulletActiveClass}-main`.split(" ")), r === s && o(i, "prev"), r === n && o(i, "next"))
                });
                else {
                    let i = u[t];
                    if (i && i.classList.add(...d.bulletActiveClass.split(" ")), e.isElement && u.forEach((e, i) => {
                            e.setAttribute("part", i === t ? "bullet-active" : "bullet")
                        }), d.dynamicBullets) {
                        let e = u[s],
                            t = u[n];
                        for (let e = s; e <= n; e += 1) u[e] && u[e].classList.add(...`${d.bulletActiveClass}-main`.split(" "));
                        o(e, "prev"), o(t, "next")
                    }
                }
                if (d.dynamicBullets) {
                    let t = Math.min(u.length, d.dynamicMainBullets + 4),
                        i = (r * t - r) / 2 - c * r,
                        s = a ? "right" : "left";
                    u.forEach(t => {
            ...
            p.forEach((i, r) => {
                if ("fraction" === d.type && (i.querySelectorAll(ef(d.currentClass)).forEach(e => {
                        e.textContent = d.formatFractionCurrent(t + 1)
                    }), i.querySelectorAll(ef(d.totalClass)).forEach(e => {
                        e.textContent = d.formatFractionTotal(u)
                    })), "progressbar" === d.type) {
                    let s;
                    s = d.progressbarOpposite ? e.isHorizontal() ? "vertical" : "horizontal" : e.isHorizontal() ? "horizontal" : "vertical";
                    let r = (t + 1) / u,
                        a = 1,
                        l = 1;
                    "horizontal" === s ? a = r : l = r, i.querySelectorAll(ef(d.progressbarFillClass)).forEach(t => {
                        t.style.transform = `translate3d(0,0,0) scaleX(${a}) scaleY(${l})`, t.style.transitionDuration = `${e.params.speed}ms`
                    })
                }
                "custom" === d.type && d.renderCustom ? (M(i, d.renderCustom(e, t + 1, u)), 0 === r && s("paginationRender", i)) : (0 === r && s("paginationRender", i), s("paginationUpdate", i)), e.params.watchOverflow && e.enabled && i.classList[e.isLocked ? "add" : "remove"](d.lockClass)
            })
        }
        ...
        function c() {
            ...
            if ("bullets" === t.type) {
                ...
                for (let i = 0; i < s; i += 1) t.renderBullet ? a += t.renderBullet.call(e, i, t.bulletClass) : a += `<${t.bulletElement} ${e.isElement?'part="bullet"':""} class="${t.bulletClass}"></${t.bulletElement}>`
            }
            "fraction" === t.type && (a = t.renderFraction ? t.renderFraction.call(e, t.currentClass, t.totalClass) : `<span class="${t.currentClass}"></span> / <span class="${t.totalClass}"></span>`), "progressbar" === t.type && (a = t.renderProgressbar ? t.renderProgressbar.call(e, t.progressbarFillClass) : `<span class="${t.progressbarFillClass}"></span>`), e.pagination.bullets = [], r.forEach(i => {
                "custom" !== t.type && M(i, a || ""), "bullets" === t.type && e.pagination.bullets.push(...i.querySelectorAll(ef(t.bulletClass)))
            }), "custom" !== t.type && s("paginationRender", r[0])
        }

        function u() {
            let t;
            e.params.pagination = ec(e, e.originalParams.pagination, e.params.pagination, {
                el: "swiper-pagination"
            });
            let i = e.params.pagination;
            !i.el || ("string" == typeof i.el && e.isElement && (t = e.el.querySelector(i.el)), t || "string" != typeof i.el || (t = [...document.querySelectorAll(i.el)]), t || (t = i.el), t && 0 !== t.length && (e.params.uniqueNavElements && "string" == typeof i.el && Array.isArray(t) && t.length > 1 && (t = [...e.el.querySelectorAll(i.el)]).length > 1 && (t = t.find(t => T(t, ".swiper")[0] === e.el)), Array.isArray(t) && 1 === t.length && (t = t[0]), Object.assign(e.pagination, {
                el: t
            }), (t = C(t)).forEach(t => {
                "bullets" === i.type && i.clickable && t.classList.add(...(i.clickableClass || "").split(" ")), t.classList.add(i.modifierClass + i.type), t.classList.add(e.isHorizontal() ? i.horizontalClass : i.verticalClass), "bullets" === i.type && i.dynamicBullets && (t.classList.add(`${i.modifierClass}${i.type}-dynamic`), l = 0, i.dynamicMainBullets < 1 && (i.dynamicMainBullets = 1)), "progressbar" === i.type && i.progressbarOpposite && t.classList.add(i.progressbarOppositeClass), i.clickable && t.addEventListener("click", d), e.enabled || t.classList.add(i.lockClass)
            })))
        }
        ...
        i("changeDirection", () => {
            ...
            !1 === e.params.pagination.enabled ? f() : (u(), c(), p())
        }), i("activeIndexChange", () => {
            ...
            t && (t = C(t)).forEach(t => t.classList[e.enabled ? "remove" : "add"](e.params.pagination.lockClass))
        }), i("lock unlock", () => {
            p()
        }), i("click", (t, i) => {
            let r = i.target,
                a = C(e.pagination.el);
            if (e.params.pagination.el && e.params.pagination.hideOnClick && a && a.length > 0 && !r.classList.contains(e.params.pagination.bulletClass)) {
                if (e.navigation && (e.navigation.nextEl && r === e.navigation.nextEl || e.navigation.prevEl && r === e.navigation.prevEl)) return;
                !0 === a[0].classList.contains(e.params.pagination.hiddenClass) ? s("paginationShow") : s("paginationHide"), a.forEach(t => t.classList.toggle(e.params.pagination.hiddenClass))
            }
        });
        let f = () => {
            ...
            t && (t = C(t)).forEach(t => t.classList.add(e.params.pagination.paginationDisabledClass)), h()
        };
        Object.assign(e.pagination, {
            enable: () => {
                ...
                t && (t = C(t)).forEach(t => t.classList.remove(e.params.pagination.paginationDisabledClass)), u(), c(), p()
            },
            disable: f,
            render: c,
            update: p,
    ...
    function eg({
        ...
        let g = r && r.autoplay ? r.autoplay.delay : 3e3,
            v = r && r.autoplay ? r.autoplay.delay : 3e3,
            w = new Date().getTime();

        function b(t) {
            !e || e.destroyed || !e.wrapperEl || t.target !== e.wrapperEl || (e.wrapperEl.removeEventListener("transitionend", b), m || t.detail && t.detail.bySwiperTouchMove || C())
        }
        let y = () => {
                if (e.destroyed || !e.autoplay.running) return;
                e.autoplay.paused ? d = !0 : d && (v = n, d = !1);
                let t = e.autoplay.paused ? n : w + v - new Date().getTime();
                e.autoplay.timeLeft = t, s("autoplayTimeLeft", t, t / g), l = requestAnimationFrame(() => {
                    y()
                })
            },
            S = t => {
                ...
                let r = (() => {
                    let t;
                    if (t = e.virtual && e.params.virtual.enabled ? e.slides.find(e => e.classList.contains("swiper-slide-active")) : e.slides[e.activeIndex]) return parseInt(t.getAttribute("data-swiper-autoplay"), 10)
                })();
                !Number.isNaN(r) && r > 0 && void 0 === t && (i = r, g = r, v = r), n = i;
                let o = e.params.speed,
                    d = () => {
                        e && !e.destroyed && (e.params.autoplay.reverseDirection ? !e.isBeginning || e.params.loop || e.params.rewind ? (e.slidePrev(o, !0, !0), s("autoplay")) : e.params.autoplay.stopOnLastSlide || (e.slideTo(e.slides.length - 1, o, !0, !0), s("autoplay")) : !e.isEnd || e.params.loop || e.params.rewind ? (e.slideNext(o, !0, !0), s("autoplay")) : e.params.autoplay.stopOnLastSlide || (e.slideTo(0, o, !0, !0), s("autoplay")), e.params.cssMode && (w = new Date().getTime(), requestAnimationFrame(() => {
                            S()
                        })))
                    };
            ...
            E = () => {
                w = new Date().getTime(), e.autoplay.running = !0, S(), s("autoplayStart")
            },
            T = () => {
            ...
            x = (t, i) => {
                ...
                let r = () => {
                    s("autoplayPause"), e.params.autoplay.waitForTransition ? e.wrapperEl.addEventListener("transitionend", b) : C()
                };
                if (e.autoplay.paused = !0, i) {
                    h && (n = e.params.autoplay.delay), h = !1, r();
                    return
                }
                n = (n || e.params.autoplay.delay) - (new Date().getTime() - w), e.isEnd && n < 0 && !e.params.loop || (n < 0 && (n = 0), r())
            },
            C = () => {
                e.isEnd && n < 0 && !e.params.loop || e.destroyed || !e.autoplay.running || (w = new Date().getTime(), f ? (f = !1, S(n)) : S(), e.autoplay.paused = !1, s("autoplayResume"))
            },
            M = () => {
                if (e.destroyed || !e.autoplay.running) return;
                let t = o();
                "hidden" === t.visibilityState && (f = !0, x(!0)), "visible" === t.visibilityState && C()
            },
            P = t => {
                "mouse" !== t.pointerType || (f = !0, m = !0, e.animating || e.autoplay.paused || x(!0))
            },
            L = t => {
                "mouse" === t.pointerType && (m = !1, e.autoplay.paused && C())
            };
        i("init", () => {
            e.params.autoplay.enabled && (e.params.autoplay.pauseOnMouseEnter && (e.el.addEventListener("pointerenter", P), e.el.addEventListener("pointerleave", L)), o().addEventListener("visibilitychange", M), E())
        }), i("destroy", () => {
            e.el && "string" != typeof e.el && (e.el.removeEventListener("pointerenter", P), e.el.removeEventListener("pointerleave", L)), o().removeEventListener("visibilitychange", M), e.autoplay.running && T()
        }), i("_freeModeStaticRelease", () => {
            (c || f) && C()
        }), i("_freeModeNoMomentumRelease", () => {
            e.params.autoplay.disableOnInteraction ? T() : x(!0, !0)
        }), i("beforeTransitionStart", (t, i, s) => {
            !e.destroyed && e.autoplay.running && (s || !e.params.autoplay.disableOnInteraction ? x(!0, !0) : T())
        }), i("sliderFirstMove", () => {
            if (!e.destroyed && e.autoplay.running) {
                if (e.params.autoplay.disableOnInteraction) return void T();
                p = !0, c = !1, f = !1, u = setTimeout(() => {
                    f = !0, c = !0, x(!0)
                }, 200)
            }
        }), i("touchEnd", () => {
            if (!e.destroyed && e.autoplay.running && p) {
                if (clearTimeout(u), clearTimeout(a), e.params.autoplay.disableOnInteraction) {
                    c = !1, p = !1;
                    return
                }
        ...
        t({
            ...
            setTranslate: () => {
                ...
                for (let i = 0; i < t.length; i += 1) {
                    ...
                    let a = e.params.fadeEffect.crossFade ? Math.max(1 - Math.abs(t.progress), 0) : 1 + Math.min(Math.max(t.progress, -1), 0),
                        l = function(e, t) {
                            let i = v(t);
                            return i !== t && (i.style.backfaceVisibility = "hidden", i.style["-webkit-backface-visibility"] = "hidden"), i
                        }(0, t);
                    l.style.opacity = a, l.style.transform = `translate3d(${s}px, ${r}px, 0px)`
                }
            },
            setTransition: t => {
                let i = e.slides.map(e => v(e));
                i.forEach(e => {
    ...
    e.s(["default", () => eh], 985234), e.s(["default", () => em], 812379), e.s(["default", () => ev], 809598), e.s([], 941983), e.s(["Autoplay", () => eg], 872225)
}]);