(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 233525, (e, t, r) => {
    ...
    function s(e) {
        let {
            auth: t,
            hostname: r
        } = e, n = e.protocol || "", o = e.pathname || "", s = e.hash || "", i = e.query || "", u = !1;
        t = t ? encodeURIComponent(t).replace(/%3A/i, ":") + "@" : "", e.host ? u = t + e.host : r && (u = t + (~r.indexOf(":") ? `[${r}]` : r), e.port && (u += ":" + e.port)), i && "object" == typeof i && (i = String(a.urlQueryToSearchParams(i)));
        let c = e.search || i && `?${i}` || "";
        return n && !n.endsWith(":") && (n += ":"), e.slashes || (!n || l.test(n)) && !1 !== u ? (u = "//" + (u || ""), o && "/" !== o[0] && (o = "/" + o)) : u || (u = ""), s && "#" !== s[0] && (s = "#" + s), c && "?" !== c[0] && (c = "?" + c), o = o.replace(/[?#]/g, encodeURIComponent), c = c.replace("#", "%23"), `${n}${u}${o}${c}${s}`
    }
    ...
    function y(t) {
        var r;
        let n, o, a, [i, y] = (0, s.useOptimistic)(h.IDLE_LINK_STATUS),
            b = (0, s.useRef)(null),
            {
                href: v,
                as: j,
        ...
        n = w, T && ("string" == typeof n || "number" == typeof n) && (n = (0, l.jsx)("a", {
            children: n
        }));
        let A = s.default.useContext(u.AppRouterContext),
            F = !1 !== P,
            U = !1 !== P ? null === (r = P) || "auto" === r ? g.FetchStrategy.PPR : g.FetchStrategy.Full : g.FetchStrategy.PPR,
            {
                href: I,
                as: B
            } = s.default.useMemo(() => {
        ...
        let z = T ? o && "object" == typeof o && o.ref : $,
            D = s.default.useCallback(e => (null !== A && (b.current = (0, h.mountLinkInstance)(e, I, A, U, F, y)), () => {
                b.current && ((0, h.unmountLinkForCurrentNavigation)(b.current), b.current = null), (0, h.unmountPrefetchableInstance)(e)
            }), [F, I, A, U, y]),
            K = {
                ref: (0, c.useMergedRef)(D, z),
                onClick(t) {
                    T || "function" != typeof C || C(t), T && o.props && "function" == typeof o.props.onClick && o.props.onClick(t), !A || t.defaultPrevented || function(t, r, n, o, a, l, i) {
                ...
                onMouseEnter(e) {
                    T || "function" != typeof k || k(e), T && o.props && "function" == typeof o.props.onMouseEnter && o.props.onMouseEnter(e), A && F && (0, h.onNavigationIntent)(e.currentTarget, !0 === L)
                },
                onTouchStart: function(e) {
                    T || "function" != typeof S || S(e), T && o.props && "function" == typeof o.props.onTouchStart && o.props.onTouchStart(e), A && F && (0, h.onNavigationIntent)(e.currentTarget, !0 === L)
                }
            };
        return (0, f.isAbsoluteUrl)(B) ? K.href = B : T && !N && ("a" !== o.type || "href" in o.props) || (K.href = (0, d.addBasePath)(B)), a = T ? s.default.cloneElement(o, K) : (0, l.jsx)("a", {
            ...M,
            ...K,
            children: n
        }), (0, l.jsx)(x.Provider, {
    ...
    e.s(["default", 0, ({
        ...
        children: (0, t.jsxs)("div", {
            ...
            children: [(0, t.jsx)("div", {
                className: "mb-8",
                children: (0, t.jsx)("h1", {
                    className: "text-9xl font-bold text-red-500 opacity-20 leading-none",
                    children: "500"
                })
            }), (0, t.jsxs)("div", {
                className: "mb-8",
                ...
                children: [(0, t.jsx)(o.default, {
                    onClick: a,
                    className: "bg-[#59344F] hover:bg-[#4a2a3f] text-white text-lg shadow-md hover:shadow-lg",
                    size: "lg",
                    children: "Try Again"
                }), (0, t.jsx)(o.default, {
                    href: "/",
                    className: "border-2 border-[#59344F] text-[#59344F] hover:bg-[#59344F] hover:text-white text-lg",
                    size: "lg",
