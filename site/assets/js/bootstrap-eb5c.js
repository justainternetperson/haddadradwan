(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 312718, (e, t, r) => {
    ...
    let a = e.r(476963),
        u = e.r(968391),
        i = "undefined" == typeof window ? e.r(362266).actionAsyncStorage : void 0;
    ...
    let u = e.r(312718),
        i = e.r(839470);
    var c = ((n = {})[n.Static = 1] = "Static", n[n.Runtime = 2] = "Runtime", n[n.Dynamic = 3] = "Dynamic", n);
    class s {
        constructor(e = null) {
        ...
        getStagePromise(e) {
            switch (e) {
                ...
                default:
                    throw Object.defineProperty(new u.InvariantError(`Invalid render stage: ${e}`), "__NEXT_ERROR_CODE", {
                        value: "E881",
                        enumerable: !1,
                        configurable: !0
                    })
        ...
        delayUntilStage(e, t, r) {
            var n, o, a;
            let u, i = (n = this.getStagePromise(e), o = t, a = r, u = new Promise((e, t) => {
                n.then(e.bind(null, a), t)
            }), void 0 !== o && (u.displayName = o), u);
    ...
    let i = (n = e.r(271645)) && n.__esModule ? n : {
            default: n
        },
        c = e.r(476353),
        s = e.r(643248),
    ...
    function j(e, t, r, n) {
        ...
        S(e, t, n), o && null === o.syncDynamicErrorWithStack && (o.syncDynamicErrorWithStack = r)
    }
    ...
    function x(e, t, r) {
        (function() {
            ...
            expression: t
        }), i.default.unstable_postpone(A(e, t))
    }
    ...
    if (!1 === N(A("%%%", "^^^"))) throw Object.defineProperty(Error("Invariant: isDynamicPostpone misidentified a postpone reason. This is a bug in Next.js"), "__NEXT_ERROR_CODE", {
        value: "E296",
        enumerable: !1,
        configurable: !0
    });
...
${t}`))
        ...
        switch (e.type) {
            ...
            case "prerender-runtime":
                ...
                if (e.cacheSignal) e.cacheSignal.inputReady().then(() => {
                    ...
                    r ? r.then(() => (0, _.scheduleOnNextTick)(() => t.abort())) : (0, _.scheduleOnNextTick)(() => t.abort())
                }
                return t.signal;
            case "prerender-client":
            case "prerender-ppr":
    ...
    function F(e) {
        ...
        if (t && r) switch (r.type) {
            ...
            case "prerender": {
                ...
                n && n.size > 0 && i.default.use((0, f.makeHangingPromise)(r.renderSignal, t.route, e));
                break
            }
            case "prerender-ppr": {
                let n = r.fallbackRouteParams;
    ...
    function V(e, t, r, n) {
        if (!K.test(t)) {
            ...
            if (q.test(t)) {
                ...
                let i = (o = `Route "${e.route}": Uncached data was accessed outside of <Suspense>. This delays the entire page from rendering, resulting in a slow user experience. Learn more: https://nextjs.org/docs/messages/blocking-route`, a = t, (u = Object.defineProperty(Error(o), "__NEXT_ERROR_CODE", {
                    value: "E394",
                    enumerable: !1,
                    configurable: !0
                })).stack = u.name + ": " + o + a, u);
    ...
    var Q = ((o = {})[o.Full = 0] = "Full", o[o.Empty = 1] = "Empty", o[o.Errored = 2] = "Errored", o);
  ...
  - Rerun the production build with \`next build --debug-prerender\` to generate better stack traces.`))
    ...
    function Z(e, t, r, n) {
        if (n.syncDynamicErrorWithStack) throw J(e, n.syncDynamicErrorWithStack), new s.StaticGenBailoutError;
        if (0 !== t) {
            if (r.hasSuspenseAboveBody) return;
            let n = r.dynamicErrors;
            if (n.length > 0) {
                for (let t = 0; t < n.length; t++) J(e, n[t]);
    ...
    let n = "undefined" == typeof window ? e.r(891414).unstable_rethrow : e.r(115507).unstable_rethrow;
    ("function" == typeof r.default || "object" == typeof r.default && null !== r.default) && void 0 === r.default.__esModule && (Object.defineProperty(r.default, "__esModule", {
        value: !0
    }), Object.assign(r.default, r), t.exports = r.default)
}, 592805, (e, t, r) => {
    ...
    let a = e.r(190809)._(e.r(271645)),
        ...
        _ = "undefined" == typeof window ? e.r(67673).useDynamicSearchParams : void 0;
    ...
    function m() {
        return p?.("usePathname()"), (0, a.useContext)(i.PathnameContext)
    }
    ...
    function h() {
        return p?.("useParams()"), (0, a.useContext)(i.PathParamsContext)
    }
    ...
    function g(e = "children") {
        p?.("useSelectedLayoutSegment()"), (0, a.useContext)(i.NavigationPromisesContext);
        let t = E(e);
